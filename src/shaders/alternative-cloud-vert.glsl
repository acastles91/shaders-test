...
//varying vec3 v_Normal; // Declare v_Normal as output
//varying vec2 v_Uv; // Declare v_UV as output
//varying vec3 v_ObjectSpacePosition;
//uniform float uTime;
...
void main() {
    // Pass the object-space position, normal, and UV coordinates to the fragment shader
    v_ObjectSpacePosition = position;
    v_Normal = normal;
    v_Uv = uv;

    // Calculate the model-view position and project it
...
//out vec3 v_Position;
//out vec3 v_Normal; // Declare v_Normal as output
//out vec2 v_Uv; // Declare v_UV as output
//out vec3 v_ObjectSpacePosition;
//out vec3 position;
//out vec3 normal; // Declare normal as input
//out vec2 uv; // Declare uv as input
//
//void main() {
//    //vec3 coords = normal;
//    //coords.y += uTime;
...
//    //vec3 newPosition = position + normalize(normal) * (displacement * 0.1); // Reduce the displacement factor if necessary
//
//    ////MVP
